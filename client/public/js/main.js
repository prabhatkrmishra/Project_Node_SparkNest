    ...
    * -------------------------------------------------- */
    const ssPreloader = function() {
        ...
        window.addEventListener('load', function() {
            ...
            preloader.addEventListener('transitionend', function afterTransition(event) {
                if (event.target.matches('#preloader'))  {
                    // siteBody.classList.add('ss-show');
                    event.target.style.display = 'none';
                    preloader.removeEventListener(event.type, afterTransition);
                }
            });
        });
