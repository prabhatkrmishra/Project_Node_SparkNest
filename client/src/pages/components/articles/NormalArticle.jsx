    ...
    <>
        ...
        <div className="entry__text">
          <div className="entry__header">
            ...
            <h1 className="entry__title">
              <a href="single-standard.html">Just a Normal Simple Blog Post.</a>
            </h1>
          </div>
        ...
        <div className="entry__text">
          ...
          <div className="entry__excerpt">
            <p>
              ...
              consectetur a sit modi quam debitis non omnis. Enim ullam
              voluptatem ipsum soluta sed debitis nihil quasi. Et et et sit.
        ...
        <div className="entry__text">
          ...
          <div className="entry__excerpt">
            <p>
              ...
              necessitatibus tempora dolorem. Harum animi tempora odio natus et
              et perferendis possimus. Aut quo mollitia libero molestiae aut
              molestiae voluptate tempore. Eius voluptatem eligendi .
            </p>
          </div>
          <a className="entry__more-link" href="#0">
            Read More
        ...
        <div className="entry__text">
          ...
          <div className="entry__excerpt">
            <p>
              ...
              incididunt mollit id et sit proident dolor nulla sed commodo est
              ad minim elit reprehenderit nisi officia aute incididunt velit
              sint in aliqua cillum in consequat consequat.
            </p>
          </div>
          <a className="entry__more-link" href="#0">
            Read More
      ...
      <article className="brick entry" data-animate-el>
        ...
        <div className="entry__text">
          ...
          <div className="entry__excerpt">
            <p>
              Consequatur amet voluptatem aliquid fuga. Consequatur tempora eos
              earum deleniti repellendus ducimus. Qui ipsum voluptas sed et ad
              dignissimos explicabo maxime dolor. Rerum quia et. Suscipit
              similique et. Atque tenetur provident. Excepturi autem unde.
            </p>
          </div>
          <a className="entry__more-link" href="#0">
            Read More
      ...
      <article className="brick entry" data-animate-el>
        ...
        <div className="entry__text">
          <div className="entry__header">
            ...
            <h1 className="entry__title">
              <a href="single-standard.html">Red and Blue Photo Effects.</a>
            </h1>
          </div>
          <div className="entry__excerpt">
            <p>
      ...
      <article className="brick entry" data-animate-el>
        ...
        <div className="entry__text">
          ...
          <div className="entry__excerpt">
            <p>
              Ratione qui voluptas reprehenderit facilis soluta ut nam.
              Distinctio cum excepturi et. Aperiam blanditiis voluptatem. A esse
              sunt nesciunt voluptate. Architecto voluptas id rerum placeat
              nostrum et optio. Placeat occaecati voluptas.
            </p>
          </div>
          <a className="entry__more-link" href="#0">
            Read More
        ...
        <div className="entry__text">
          ...
          <div className="entry__excerpt">
            <p>
              ...
              incididunt mollit id et sit proident dolor nulla sed commodo est
              ad minim elit reprehenderit nisi officia aute incididunt velit
              sint in aliqua cillum in consequat.
            </p>
          </div>
          <a className="entry__more-link" href="#0">
            Read More
      ...
      <article className="brick entry" data-animate-el>
        ...
        <div className="entry__text">
          <div className="entry__header">
            ...
            <h1 className="entry__title">
              <a href="single-standard.html">Symmetry In Modern Design.</a>
            </h1>
          </div>
          <div className="entry__excerpt">
            <p>
              Praesentium vel similique laboriosam repudiandae mollitia error.
              Inventore numquam occaecati omnis beatae fugiat. Porro sed numquam
              doloribus dolores exercitationem recusandae culpa. Sint vel vel
              quia quis. Non velit eum ea tempora quas sapiente.
            </p>
          </div>
          <a className="entry__more-link" href="#0">
            Read More
      ...
      <article className="brick entry" data-animate-el>
        ...
        <div className="entry__text">
          ...
          <div className="entry__excerpt">
            <p>
              Need hosting? We would highly recommend DreamHost. Enjoy 100%
      ...
      <article className="brick entry" data-animate-el>
        ...
        <div className="entry__text">
          ...
          <div className="entry__excerpt">
            <p>
              Voluptatem maiores aut delectus accusamus et explicabo et. Enim
              sunt quo odio sit. Hic consequatur et quia voluptas saepe. Vel
              nostrum incidunt ab eum distinctio recusandae. Labore dolore
              consequatur occaecati iste ex consectetur et perferendis.
            </p>
          </div>
          <a className="entry__more-link" href="#0">
            Read More
